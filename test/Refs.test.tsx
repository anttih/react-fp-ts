...
import { Ref } from '../src/refs'
import { ReducerComponent, _capture, reducerComponent, make, Self, sideEffects, update, noUpdate } from '..'
...
const component: ReducerComponent<{}> = reducerComponent('Test')
